...
import { l as levels, g as getEventPrefix, L as Logger, A as AstroIntegrationLogger, manifest } from './manifest_AhMJxB_E.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
import { A as AstroError, R as ResponseSentError, l as MiddlewareNoDataOrNextCalled, n as MiddlewareNotAResponse, G as GetStaticPathsRequired, o as InvalidGetStaticPathsReturn, p as InvalidGetStaticPathsEntry, q as GetStaticPathsExpectedParams, t as GetStaticPathsInvalidRouteParam, P as PageNumberParamNotFound, N as NoMatchingStaticPathFound, u as PrerenderDynamicEndpointPathCollide, v as LocalsNotAnObject, w as ASTRO_VERSION, C as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, x as renderEndpoint, y as ReservedSlotName, z as renderSlotToString, B as renderJSX, D as chunkToString, F as CantRenderPage, H as renderPage$1 } from './chunks/astro_81H4FYWo.mjs';
...
const _page1  = () => import('./chunks/node_LbuKB_9G.mjs');
const _page2  = () => import('./chunks/index_wWOB-_o4.mjs');
const _page3  = () => import('./chunks/registrar_BF8aBTre.mjs');
const _page4  = () => import('./chunks/_modelo__JfcnS_hL.mjs');
const _page5  = () => import('./chunks/compra_7BfY53Jc.mjs');
const _page6  = () => import('./chunks/_modelo__rEJZZVHf.mjs');
const _page7  = () => import('./chunks/login_BWMEJYyd.mjs');const pageMap = new Map([["node_modules/auth-astro/src/api/[...auth].ts", _page0],["node_modules/astro/dist/assets/endpoint/node.js", _page1],["src/pages/index.astro", _page2],["src/pages/registrar.astro", _page3],["src/pages/product/[modelo].astro", _page4],["src/pages/compra.astro", _page5],["src/pages/marcas/[modelo].astro", _page6],["src/pages/login.astro", _page7]]);
const _manifest = Object.assign(manifest, {
	pageMap,
	renderers,
});
const _args = {"mode":"standalone","client":"file:///home/kikealcocerdz/Documents/year-3/INTERFACES/interfaces_cp/dist/client/","server":"file:///home/kikealcocerdz/Documents/year-3/INTERFACES/interfaces_cp/dist/server/","host":false,"port":4321,"assets":"_astro"};
